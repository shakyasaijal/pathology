	...
	<div class="container margin_60_35">
		<div class="row">
			<div class="col-lg-3 col-md-12">
				<p>
					<a href="../findoctor/index.html" title="Findoctor">
						<img src="/pathology/img/logo.png" data-retina="true" alt="" width="163" height="36" class="img-fluid">
					</a>
				</p>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div id="copy">© 2019 {% block company_name %} {% endblock %}</div>
			</div>
		</div>
	</div>
</footer>
